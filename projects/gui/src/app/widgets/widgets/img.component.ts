...
@Component({
  selector: 'ha4us-img',
  template: `<img [src]="src || '/assets/images/Sonos_Default_AlbumArt.png'" />`,
...
export class ImgComponent implements OnDestroy {
  ...
  constructor(protected states: StatesService, protected ds: DomSanitizer, protected cdr: ChangeDetectorRef) { }
