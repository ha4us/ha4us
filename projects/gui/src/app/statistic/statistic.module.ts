...
@NgModule({
  declarations: [MainComponent, QueryStatisticComponent, ChartComponent, BarChartComponent, LineChartComponent, BarVerticalTimeComponent, HistoryListComponent, HistoryInventoryComponent],
  imports: [
    CommonModule,
    MainModule,
    MatMomentDateModule,
